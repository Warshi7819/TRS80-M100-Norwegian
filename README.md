...
## Norwegian Pamphlet
This pamphlet in Norwegian was included with the unit. It basically is a Quick Start Guide that explains the most important functions. With regards to BASIC it doesn't tell you much other than how to set the Date, Day and Time. The full RadioShack TRS-80 Model 100 manual was also included (English version). 
